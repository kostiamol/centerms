...
func TestRedisConnection(t *testing.T) {
	client := redis.New()
	Convey("Check redis client connection"+dbServer.Host+":"+string(dbServer.Port)+". Should be without error ", t, func() {
...
func TestHTTPConnection(t *testing.T) {
	...
	Convey("Check http://"+localhost+":"+fmt.Sprint(httpPort)+"/devices/{id}/data. Should be without error ", t, func() {
		defer treatmentPanic("Recovered in TestWorkingServerAfterSendingJSON")
	...
	Convey("Check http://"+localhost+":"+fmt.Sprint(httpPort)+"/devices. Should be without error ", t, func() {
		defer treatmentPanic("Recovered in TestWorkingServerAfterSendingJSON")
